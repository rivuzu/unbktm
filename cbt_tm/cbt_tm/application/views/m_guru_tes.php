<div class="row">
  ...
  <div class="panel panel-success">
    <div class="panel-heading">
      Daftar Ujian / Tes
        <a class="btn btn-success btn-sm" href="#" onclick="return m_ujian_e(0);" style="float:right; padding:5px; margin-top:-5px;"><i class="glyphicon glyphicon-plus"></i> &nbsp;&nbsp;Tambah</a>
    </div>
          ...
          <form name="f_ujian" id="f_ujian" onsubmit="return m_ujian_s();">
            ...
            <input type="hidden" name="jumlah_soal1" id="jumlah_soal1" value="0">
              <table class="table table-form">
                ...
                <tr><td>Jurusan</td><td><div class="col-md-10"><?php echo form_dropdown('jurusan', $p_jurusan, '', 'class="form-control" id="jurusan" required'); ?></div></td></tr>
                <tr><td>Jumlah Soal Tampil</td><td><?php echo form_input('jumlah_soal', '', 'class="form-control"  id="jumlah_soal" required'); ?></td></tr>
